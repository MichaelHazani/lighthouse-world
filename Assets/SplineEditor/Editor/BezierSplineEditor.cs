...
public class BezierSplineEditor : Editor
{
	...
	void OnSceneGUI()
	{
		if(m_splinecomp != null)
		{
			...
			Undo.SetSnapshotTarget(m_splinecomp, "BezierSpline Modify");
	...
	[MenuItem("GameObject/Create Other/BezierSpline")]
	public static void CreateBezierSpline()
	{
		GameObject go = new GameObject("BezierSpline");
		go.AddComponent(typeof(BezierSplineComponent));
	}
}