...
public class BezierSpline : BaseSpline
{
	public class EditHelper
	{
		...
		public void AppendPoint()
		{
			...
			{
				m_spline.AppendPoint(Vector3.zero, BaseSpline.SplinePointType.Corner, Vector3.zero, Vector3.zero);
			}
			else
			{
				m_spline.AppendPoint(m_spline.m_points[m_spline.m_points.Count - 1].m_point + Vector3.right, BaseSpline.SplinePointType.Corner, Vector3.zero, Vector3.zero);
			}
		...
		public void InsertBefore()
		{
			...
			{
				m_spline.InsertPoint(0, m_spline.m_points[m_spline.m_points.Count - 1].m_point + Vector3.right, BaseSpline.SplinePointType.Corner, Vector3.zero, Vector3.zero);
			}
			else
			{
				...
				m_spline.InsertPoint(previdx, (m_spline.m_points[m_selidx].m_point + m_spline.m_points[previdx].m_point) * 0.5f, BaseSpline.SplinePointType.Corner, Vector3.zero, Vector3.zero);
				m_selidx = previdx;
			}
		}
		...
		public void InsertAfter()
		{
			...
			else
			{
				...
				m_spline.InsertPoint(m_selidx, (m_spline.m_points[m_selidx].m_point + m_spline.m_points[previdx].m_point) * 0.5f, BaseSpline.SplinePointType.Corner, Vector3.zero, Vector3.zero);
			}
		}
